...
The [http://podgursv.shinyapps.io/project_1][app] provide an interactive way to compute the Z-scode and p-value of a user-provided quantile given a user-specified distribution.  This is convenient, because traditionally, a printed lookup table was used.
